...
class Game:
    def __init__(self, state_stack, window, clock, music_handler, sfx_handler, framerate, config, gui_factory, block_factory, file_save_handler, item_factory, animation_handler_factory):
        ...
        self._animation_handler_factory = animation_handler_factory
    ...
    @property
    def animation_handler_factory(self):
        return self._animation_handler_factory
