...
class World:
    ...
    def update(self):
        if self._player is None:
            ...
            self._player.hotbar.pickup_item(self._game.item_factory.create_item(self._game, self, "trap_door"))
            self._player.hotbar.pickup_item(self._game.item_factory.create_item(self._game, self, "chest_block"))
